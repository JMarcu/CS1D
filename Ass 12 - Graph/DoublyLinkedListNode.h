...
class DLLNode
{
	...
	public:
		...
		*******************************************/
		...
		ElemType& GetElem();//Gets the value of elem.
		...
		*******************************************/
		...
		void SetElem(ElemType& data);//Sets the value of elem.
 ...
 *************************************************************************/
template <class ElemType>
ElemType& DLLNode<ElemType>::GetElem()
{
	return elem;
}
 ...
 *************************************************************************/
template <class ElemType>
void DLLNode<ElemType>::SetElem(ElemType& newElem)
{
	elem = newElem;
}
