...
class DoublyLinkedList
{
	...
	public:
		...
		* * * *          MUTATORS           * * * *
		*******************************************/
		void Add(ElemType& newElem,      //Adds a node with newElem before
				 node* beforeHere);            //another node in the list.
		void AddFront(ElemType& newElem);//Adds a new node to the front.
		void AddBack(ElemType& newElem); //Adds a new node to the back.
 ...
 *************************************************************************/
template <class ElemType>
void DoublyLinkedList<ElemType>::Add(ElemType& newElem,//IN - The new node's
		                                                     //     element.
 ...
 *************************************************************************/
template <class ElemType>
void DoublyLinkedList<ElemType>::AddFront(ElemType& newElem)//IN - New node's element.
{
 ...
 *************************************************************************/
template <class ElemType>
void DoublyLinkedList<ElemType>::AddBack(ElemType& newElem)//IN - New node's element.
{
	Add(newElem, tail);
}
