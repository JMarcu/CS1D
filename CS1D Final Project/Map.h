...
class Map
{
	public:
		...
		* * * * CONSTRUCTORS AND DESTRUCTOR * * * *
		*******************************************/
		Map(int(*hashOne)(const KeyType&), //Constructor which specifies
			int(*hashTwo)(const KeyType&));//hashing functions.
 ...
 * Takes in two pointer-to-functions. These functions will be used by
 * the map's internal hash table as hashing functions.
 * ______________________________________________________________________
 * PRE-CONDITIONS -
 *  hashOne : Pointer to the internal hash table's first hashing function.
 *  hashTwo : Pointer to the internal hash table's second hashing function.
 *
 * POST-CONDITIONS -
 * 	Constructs an instance of Map.
 *************************************************************************/
template <typename KeyType, typename ElemType>
Map<KeyType, ElemType>::Map(int(*hashOne)(const KeyType&),
		                    int(*hashTwo)(const KeyType&))
{
	table = new HashTable<KeyType, ElemType>(hashOne, hashTwo);
}
 ...
 *************************************************************************/
template <typename KeyType, typename ElemType>
HashNode<KeyType, ElemType>* Map<KeyType, ElemType>::Find(const KeyType& key) const
{
 ...
 *************************************************************************/
template <typename KeyType, typename ElemType>
void Map<KeyType, ElemType>::Put(const KeyType& key, const ElemType& value)
{
	table->Put(key, value);
}
 ...
 *************************************************************************/
template <typename KeyType, typename ElemType>
Map<KeyType, ElemType>::Iterator::Iterator(int posInit, node* buck)
{
	it = new typename HashTable<KeyType, ElemType>::Iterator(posInit, buck);
}
 ...
 *************************************************************************/
template <typename KeyType, typename ElemType>
typename HashTable<KeyType, ElemType>::Iterator Map<KeyType, ElemType>::Iterator::operator->() const
{
	return it;
}
