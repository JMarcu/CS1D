 ...
 * This is the default first hash function for the double hash algorithm
 * found in the HashTable class below.
 * ______________________________________________________________________
 * PRE-CONDITIONS -
 *  key : the key to hash
 *
 * POST-CONDITIONS -
 * 	An integer of no greater than 17 and no less than 0 will be returned.
 *************************************************************************/
 ...
 * FUNCTION SecondHash
 * ______________________________________________________________________
 * This is the default second hash function for the double hash algorithm
 * found in the HashTable class below.
 * ______________________________________________________________________
 * PRE-CONDITIONS -
 *  key : the key to hash
 *
 * POST-CONDITIONS -
 * 	An integer of no greater than 13 and no less than 1 will be returned.
 *************************************************************************/
template <typename KeyType>
	...
	*******************************************/
	...
	public:
		...
		*******************************************/
		...
		HashTable(int(*hashOne)(const KeyType&) = FirstHash,
				  int(*hashTwo)(const KeyType&) = SecondHash);
		...
		*******************************************/
		...
		bool Empty() const;                     //Returns if the table is
		                                        //empty.
		Iterator Find(const KeyType& key) const;//Returns a iterator to the
		...
		* * * *          MUTATORS           * * * *
		*******************************************/
		Iterator Put(const KeyType& key,      //Stores a new key/value pair.
	...
	private:
		...
		* * * *         VARIABLES           * * * *
		*******************************************/
		node*     bucket[18];                    //Bucket array to store nodes.
 ...
 *************************************************************************/
template <typename KeyType, typename ElemType>
typename HashTable<KeyType, ElemType>::Iterator HashTable<KeyType, ElemType>::Put(const KeyType& key,
		                                                                          const ElemType& newElem)
{
	//VARIABLE DECLERATIONS
